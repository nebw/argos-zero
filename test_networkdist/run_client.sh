...
while true; do 
	...
	nice $SOURCES/selfplay -n $WEIGHTP/$wfile --tree-networkRollouts false --tree-trainingMode true --tree-randomizeFirstNMoves 10 --engine-resignThreshold $thres --engine-selfplayRollouts 1600
done
