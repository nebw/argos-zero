...
public:
    ...
    template <class T>
    void RegisterGfx(const string& name, const string& params, T* object, void (T::*member)(Io&));
...
template <class T>
void ReplWithGogui::RegisterGfx(const string& name, const string& params, T* object,
                                void (T::*member)(Io&)) {
    RegisterGfx(name, params, std::bind(member, object, _1));
}

template <typename T>
void ReplWithGogui::RegisterParam(const string& cmd_name, const string& param_name, T* param) {
