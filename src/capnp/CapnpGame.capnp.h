...
inline  ::capnp::List< ::StateProb>::Reader Game::Reader::getStateprobs() const {
  return ::capnp::_::PointerHelpers< ::capnp::List< ::StateProb>>::get(_reader.getPointerField(
      ::capnp::bounded<1>() * ::capnp::POINTERS));
}
inline  ::capnp::List< ::StateProb>::Builder Game::Builder::getStateprobs() {
  return ::capnp::_::PointerHelpers< ::capnp::List< ::StateProb>>::get(_builder.getPointerField(
      ::capnp::bounded<1>() * ::capnp::POINTERS));
}
inline void Game::Builder::setStateprobs( ::capnp::List< ::StateProb>::Reader value) {
  ::capnp::_::PointerHelpers< ::capnp::List< ::StateProb>>::set(_builder.getPointerField(
      ::capnp::bounded<1>() * ::capnp::POINTERS), value);
}
inline  ::capnp::List< ::StateProb>::Builder Game::Builder::initStateprobs(unsigned int size) {
  return ::capnp::_::PointerHelpers< ::capnp::List< ::StateProb>>::init(_builder.getPointerField(
      ::capnp::bounded<1>() * ::capnp::POINTERS), size);
}
inline void Game::Builder::adoptStateprobs(
    ::capnp::Orphan< ::capnp::List< ::StateProb>>&& value) {
  ::capnp::_::PointerHelpers< ::capnp::List< ::StateProb>>::adopt(_builder.getPointerField(
      ::capnp::bounded<1>() * ::capnp::POINTERS), kj::mv(value));
}
inline ::capnp::Orphan< ::capnp::List< ::StateProb>> Game::Builder::disownStateprobs() {
  return ::capnp::_::PointerHelpers< ::capnp::List< ::StateProb>>::disown(_builder.getPointerField(
      ::capnp::bounded<1>() * ::capnp::POINTERS));
}
